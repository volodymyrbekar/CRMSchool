...
class Student(models.Model):
    ...
    school = models.TextField(max_length=30, blank=True, null=True)
    ...
    first_call = models.CharField(max_length=50, blank=True, null=True)
    first_call_satus = models.CharField(max_length=50, blank=True, null=True)
    trial_registration = models.CharField(max_length=50, blank=True, null=True)  # trial_registration запис на пробне
    trial_status = models.CharField(max_length=20, blank=True, null=True)  # чи був на пробному?
    comment_first_call = models.CharField(max_length=250, blank=True, null=True)

    second_call = models.CharField(max_length=50, blank=True, null=True)
    second_call_satus = models.CharField(max_length=50, blank=True, null=True)
